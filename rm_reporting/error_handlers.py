...
def sql_alchemy_error(error):
    print("YOU ENTERED THE ERROR HANDLER FUNCTION 1")
    return "sql alchemy error handled"


@blueprint.app_errorhandler(ProgrammingError)
def programming_error(error):
    print("YOU ENTERED THE ERROR HANDLER FUNCTION 2")
    return "programming error handled"
